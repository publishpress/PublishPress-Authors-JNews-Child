                                    ...
                                    <div class="jeg_meta_container">
                                        <div class="jeg_post_meta">
	                                        <?php if ( jnews_check_coauthor_plus() ) : ?>
		                                        <div class="jeg_meta_author coauthor a1">
			                                        <?php echo jnews_get_author_coauthor( get_the_ID(), false, null, 1 ); ?>
		                                        </div>
	                                        <?php elseif (function_exists('get_multiple_authors')) : ?>
                                                <div class="jeg_meta_author a2">
